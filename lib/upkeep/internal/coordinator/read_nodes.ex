defmodule Upkeep.Internal.Coordinator.ReadNodes do
  @moduledoc false

  alias Upkeep.Internal.SingleFlight.Registry
  alias Upkeep.Internal.Ecto.QueryDeps
  ...
  @doc false
  def coalescer_name, do: Upkeep.Internal.Coordinator.ReadNodes.Coalescer
